...
- Если в сообщении одновременно присутствуют: предложение/поиск работы или услуги; денежное вознаграждение или цена; призыв связаться с автором ("лс", "в личку", "пишите");
